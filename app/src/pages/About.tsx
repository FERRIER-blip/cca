...
{/* Introduction */}
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              {/* Le cadre principal : overflow-hidden masque les boules quand elles sortent */}
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-transparent flex items-center justify-center">
                
                {/* --- LE TEXTE CENTRAL (EN ARRIÈRE-PLAN) --- */}
                {/* z-10 le garde au fond. J'ai retiré le flou pour ne pas interférer avec la transparence */}
                <div className="relative z-10 text-center p-8">
                  <div className="w-24 h-24 bg-[#1a237e] rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-[#1a237e]/30">
                    <span className="text-4xl font-bold text-white">CCA</span>
                  </div>
                  <p className="text-2xl font-bold text-[#1a237e]">Cabinet Construire</p>
                  <p className="text-2xl font-bold text-[#ff6f00]">l'Avenir</p>
                </div>

                {/* --- LES BOULES D'IMAGES FLOTTANTES (EN AVANT-PLAN) --- */}
                {/* z-30 garantit qu'elles passent DEVANT le texte. 
                    J'ai ajouté border-white pour qu'elles se détachent bien en survolant le texte */}
                
                {/* Boule 1 : Traversée diagonale (Haut-Gauche -> Bas-Droite) */}
                <motion.div
                  className="absolute z-30 w-32 h-32 rounded-full overflow-hidden shadow-2xl border-4 border-white"
                  animate={{
                    left: ['-20%', '110%', '-20%'],
                    top: ['-10%', '90%', '-10%'],
                  }}
                ...
                >
                  <img src="/images/image1.jpg" alt="Activité 1" className="w-full h-full object-cover" />
                </motion.div>

                {/* Boule 2 : Traversée inverse (Bas-Droite -> Haut-Gauche) */}
                <motion.div
                  className="absolute z-30 w-40 h-40 rounded-full overflow-hidden shadow-2xl border-4 border-white"
                  animate={{
                    left: ['110%', '-30%', '110%'],
                    top: ['80%', '-10%', '80%'],
                  }}
                ...
                >
                  <img src="/images/image2.jpg" alt="Activité 2" className="w-full h-full object-cover" />
                </motion.div>

                {/* Boule 3 : Traversée horizontale légèrement courbée */}
                <motion.div
                  className="absolute z-30 w-24 h-24 rounded-full overflow-hidden shadow-2xl border-4 border-white"
                  animate={{
                    left: ['-20%', '120%', '-20%'],
                    top: ['40%', '60%', '40%'],
                  }}
                ...
                >
                  <img src="/images/image3.jpg" alt="Activité 3" className="w-full h-full object-cover" />
                </motion.div>
      ...
      {/* Values */}
      <section className="py-20 bg-[#1a237e]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="w-16 h-16 bg-[#ff6f00]/10 rounded-xl flex items-center justify-center mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              ...
              >
                {/* Ajout de overflow-hidden ici pour garder l'image ronde */}
                <div className="w-40 h-40 bg-gradient-to-br from-[#1a237e] to-[#ff6f00] rounded-full flex items-center justify-center mx-auto mb-6 overflow-hidden">
                  {/* Si l'image existe on l'affiche, sinon on garde tes initiales */}
                  {member.image ? (
                    <img 
                      src={member.image} 
                      alt={member.name} 
