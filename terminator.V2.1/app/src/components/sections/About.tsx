        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 bg-[#1a237e] text-white rounded-xl p-6 shadow-xl"
            >
              <p className="text-3xl font-bold">CCA</p>
              <p className="text-sm text-white/70">Excellence depuis 2014</p>
            </motion.div>
          </motion.div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-20">
          {stats.map((stat, index) => (
            <motion.div
              ...
              whileHover={{ y: -10, backgroundColor: 'rgba(26, 35, 126, 0.05)' }}
              className="text-center p-6 rounded-xl transition-all duration-300"
            >
              <p className="text-4xl lg:text-5xl font-bold text-[#1a237e] mb-2">
